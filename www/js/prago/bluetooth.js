...
cordova.define("cordova/plugin/bluetooth", function(require, exports, module) {
	...
	/**
	 * Search for Bonded devices  and list them
	 * 
     ...
     * @param errorCallback function to be called when there was a problem while reading
     */
    Bluetooth.prototype.read2 = function(successCallback,failureCallback,socketid) {
        return exec(successCallback, failureCallback, 'BluetoothPlugin', 'read2', [socketid]);
    }
    /**
     * Read from a connected socket
     * 
     ...
     * @param errorCallback function to be called when there was a problem while reading
     */
    Bluetooth.prototype.read3 = function(successCallback,failureCallback,socketid) {
        return exec(successCallback, failureCallback, 'BluetoothPlugin', 'read3', [socketid]);
    }
    /**
     * Read from a connected socket
     * 
     ...
     * @param errorCallback function to be called when there was a problem while reading
     */
    Bluetooth.prototype.read4 = function(successCallback,failureCallback) {
        return exec(successCallback, failureCallback, 'BluetoothPlugin', 'read4',[]);
    }
	/**
	 * Write from a connected socket
	 * 
	 * @param successCallback function to be called when reading was successful. Passed parameter is a string containing the read content
	 * @param errorCallback function to be called when there was a problem while reading
	 */
	Bluetooth.prototype.write = function(successCallback,failureCallback,socketid,data) {
	    return exec(successCallback, failureCallback, 'BluetoothPlugin', 'write', [socketid,data]);
	}
